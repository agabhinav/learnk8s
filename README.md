...
## **More Info + Labs**
- [LAB: Docker and Minikube in WSL2 Ubuntu](01-k8s-lab-install-docker-minikube.md)
- [LAB: Basic kubectl commands](02-k8s-lab-kubectl.md)
- [Imperative vs Declarative](03-k8s-imperative-declarative.md)
- [Kubeconfig](04-k8s-kubeconfig.md)
- [Kubernetes Context](05-k8s-context.md)
- [LAB: namespaces](06-k8s-lab-namespaces.md)
- [LAB: Deployment](07-k8s-lab-deployment.md)
- [LAB: Service](08-k8s-lab-service.md)
- [LAB: Volumes - emptyDir](09-k8s-lab-volumes-emptydir.md)
- [LAB: Volumes - hostPath](10-k8s-lab-volumes-hostpath.md)
- [LAB: Volumes - local PV, PVC](11-k8s-lab-volumes-pv-pvc.md)
- [LAB: Secrets](12-k8s-lab-secrets.md)
- [LAB: Using Secrets as environment variables - env](13-k8s-lab-secrets-usage-env-1.md)
- [LAB: Using Secrets as environment variables - envFrom](14-k8s-lab-secrets-usage-env-2.md)
- [LAB: Using Secrets as volumes](15-k8s-lab-secrets-usage-vol.md)
- [LAB: ConfigMap](16-k8s-lab-configmap.md)
- [LAB: Jobs](17-k8s-lab-jobs.md)
---
